function checkAnswers() {
    ...
    if (q1_price && !q1_spam) totalMarks += 5;
    ...
    if (q3 && q3.value === "Regression") totalMarks += 5;

    // Question 4: RGB
    const q4 = document.querySelector('input[name="train"]:checked');
    if (q4 && q4.value === "dataset") totalMarks += 5;

    // Question 5: Color range
    if (document.getElementById("question5").value === "Binary Classification") totalMarks += 5;

    // Question 6: Supervised learning types
    if (document.getElementById("typeRegression").checked) totalMarks += 5;
    if (document.getElementById("typesupervisedlearning").checked) totalMarks += 5;

    // Question 7: Computer Vision task
    if (document.getElementById("question7").value === "label") totalMarks += 5;
    ...
    if (q10 && q10.value === "Elvenlabs") totalMarks += 5;
